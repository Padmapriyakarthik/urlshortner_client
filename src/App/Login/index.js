...
export const Login = ({handleLogin,history})=>{
   ...
   const handleSubmit = ()=>{
    ...
    return(
<div style={{backgroundImage:`url("https://mybigplunge.com/wp-content/uploads/2018/04/url-shortener-theplungedaily.jpg")`,backgroundSize:"cover",backgroundRepeat:"no-repeat"}}>
